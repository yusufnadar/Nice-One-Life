...
class DataController extends GetxController{
  ...
  final RxList<ProteinValueModel> _proteinValues = <ProteinValueModel>[].obs;
  ...
  getShowMyPackages() async{
    try{
      var paketler = await _dataService.getShowMyPackages();
      if(paketler != null){
